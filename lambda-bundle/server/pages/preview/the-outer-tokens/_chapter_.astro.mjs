...
import { g as getChapter, a as getAllChapters, c as chapterLabel, $ as $$ReaderLayout } from '../../../chunks/chapters_NMjIrnHo.mjs';
...
const $$chapter = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "ReaderLayout", $$ReaderLayout, { "title": `${isDraft ? "[DRAFT] " : ""}${entry.data.title} — The Outer Tokens`, "description": entry.data.summary }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="page" id="reader"${addAttribute(bookSlug, "data-book-slug")}${addAttribute(entry.slug, "data-chapter-slug")}${addAttribute(prevHref, "data-prev-chapter")}${addAttribute(nextHref, "data-next-chapter")}${addAttribute(label, "data-chapter-label")}${addAttribute(entry.data.title, "data-chapter-title")}> ${isDraft && renderTemplate`<div class="preview-banner">Draft Preview</div>`} <div class="running-header" id="running-header">${label} — ${entry.data.title}</div> <div class="pager-viewport" id="pager-viewport"> <article class="chapter-body" id="chapter-body"> <header class="chapter-header"> <span class="chapter-number">${label}</span> <h1 class="chapter-title">${entry.data.title}</h1> </header> ${renderComponent($$result2, "Fragment", Fragment, {}, { "default": async ($$result3) => renderTemplate`${unescapeHTML(entry.html)}` })} </article> </div> </div> <div class="page-indicator" id="page-indicator"> <div class="indicator-row indicator-row-nav"> <a class="indicator-link" href="/">Home</a> <span class="indicator-sep">/</span> <a class="indicator-link"${addAttribute(`/preview/${bookSlug}`, "href")}>Contents</a> </div> <div class="indicator-row indicator-row-pages"> <span class="page-nav"> <button class="page-nav-btn" id="page-prev" aria-label="Previous page">&lsaquo;</button> <span id="page-counter">1 / 1</span> <button class="page-nav-btn" id="page-next" aria-label="Next page">&rsaquo;</button> </span> <button class="settings-toggle" id="settings-toggle" aria-label="Reader settings">Aa</button> <div class="settings-panel" id="settings-panel" hidden> <div class="settings-row"> <button class="font-btn" id="font-down" aria-label="Decrease font size">A&minus;</button> <span class="font-label" id="font-label">100%</span> <button class="font-btn" id="font-up" aria-label="Increase font size">A+</button> </div> <div class="settings-row theme-row"> <button class="theme-btn" id="theme-light" data-theme="light" aria-label="Light theme">Light</button> <button class="theme-btn" id="theme-sepia" data-theme="sepia" aria-label="Sepia theme">Sepia</button> <button class="theme-btn" id="theme-dark" data-theme="dark" aria-label="Dark theme">Dark</button> </div> </div> </div> </div> ${renderScript($$result2, "C:/Users/Nathanial/code2/dreams_of_the_deep/src/pages/preview/the-outer-tokens/[chapter].astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "C:/Users/Nathanial/code2/dreams_of_the_deep/src/pages/preview/the-outer-tokens/[chapter].astro", void 0);
const $$file = "C:/Users/Nathanial/code2/dreams_of_the_deep/src/pages/preview/the-outer-tokens/[chapter].astro";
const $$url = "/preview/the-outer-tokens/[chapter]";
